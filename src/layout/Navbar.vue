            ...
            >
              <div class="relative">
                <div
                  ...
                  class="w-16 h-16 overflow-hidden border-2 border-gray-400 rounded-full relative z-10 block transition-colors duration-300 transform hover:bg-yellow-500 focus:outline-none focus:ring focus:ring-yellow-300 focus:ring-opacity-80"
                >
                  <img
                ...
                <router-link
                  :to="{ name: 'LoginView' }"
                  v-else
                  class="flex items-center px-4 py-2 font-medium tracking-wide text-white w-full capitalize justify-center transition-colors duration-300 transform rounded-lg focus:outline-none focus:ring bg-yellow-600 focus:ring-opacity-80"
                >
                ...
                >
                  <button
                    v-if="isAuthenticated"
                    @click="logout"
                    class="flex items-center px-4 py-2 font-medium tracking-wide text-black w-full capitalize justify-center transition-colors duration-300 transform rounded-lg focus:outline-none focus:ring bg-yellow-50 hover:bg-yellow-100 focus:ring-opacity-80"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
